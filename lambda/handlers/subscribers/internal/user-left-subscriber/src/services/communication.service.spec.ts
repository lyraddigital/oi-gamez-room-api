...
describe("communicateUserLeft tests", () => {
  ...
  it("broadcasts a user left event to all other connections only when the connectionId is not set and isBelowMinimumUsers is false", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("broadcasts a user left event to all other connections only when the username passed in is the host but is below the minimum number of users and connectionId is not set", async () => {
    // Arrange
    const roomCode = "ABCD";
    const userOneUsername = "daryl_duck";
    const userTwoUsername = "daryl_duck2";
  ...
  it("broadcasts both a user left event to all other connections as well as a disabled game start event to the host when the username passed in is not the host but is below the minimum number of users and connectionId is not set", async () => {
    // Arrange
    const roomCode = "ABCD";
    const userOneUsername = "daryl_duck";
    const userTwoUsername = "daryl_duck2";
  ...
  it("broadcasts both events and also closes the current connection as connectionId is now set", async () => {
    // Arrange
    const roomCode = "ABCD";
    const userOneUsername = "daryl_duck";
    const userTwoUsername = "daryl_duck2";
