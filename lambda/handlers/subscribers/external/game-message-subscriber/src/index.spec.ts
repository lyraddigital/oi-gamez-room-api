...
describe("game message subscriber handler tests", () => {
  ...
  it("does not send the message when the room does not exist", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("does not send the message when the room has a not available status", async () => {
    // Arrange
    const roomCode = "ABCD";
    const action = "someAction";
    const payload = {} as unknown;
  ...
  it("does not send the message when the room has a completed status", async () => {
    // Arrange
    const roomCode = "ABCD";
    const action = "someAction";
    const payload = {} as unknown;
  ...
  it("does send the message when the room has an available status", async () => {
    // Arrange
    const roomCode = "ABCD";
    const action = "someAction";
    const payload = {} as unknown;
  ...
  it("does send the message when the room has an in progress status", async () => {
    // Arrange
    const roomCode = "ABCD";
    const action = "someAction";
    const payload = {} as unknown;
