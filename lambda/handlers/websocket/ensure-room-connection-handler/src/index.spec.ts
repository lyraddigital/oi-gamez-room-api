...
describe("ensure room connection handler tests", () => {
  ...
  it("verification of event fails, returns a bad request result", async () => {
    // Arrange
  ...
  it("verification of event passes, returns an ok result", async () => {
    // Arrange
    const username = "daryl_duck";
    const roomCode = "ABCD";
    const connectionId = "conn1234";
  ...
  it("error was thrown, returns an server error response", async () => {
    // Arrange
