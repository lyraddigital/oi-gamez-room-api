...
describe("processRoomConnection for ensure room connection tests", () => {
  ...
  it("user is host, and room status is not yet available, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("user is host, and room status is available, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const connectionId = "con1234";
  ...
  it("user is not the host, the room is available, and this is a new connection, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const connectionId = "con1234";
  ...
  it("user is not the host, the room is available, and this is not a new connection, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const connectionId = "con1234";
  ...
  it("user is not the host, the room is not available, and this is a new connection, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const connectionId = "con1234";
  ...
  it("user is not the host, the room is not available, and this is not a new connection, makes the correct calls", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const connectionId = "con1234";
