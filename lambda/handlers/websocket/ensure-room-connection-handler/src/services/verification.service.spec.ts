...
describe("verifyRequestData for ensure room connection tests", () => {
  it("validation is unsuccessful, returns unsuccessful", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("validation passes but ruleset checking is unsuccessful, returns unsuccessful", async () => {
    // Arrange
    const epochTime = 2293848;
    const roomCode = "ABCD";
    const username = "daryl_duck";
  ...
  it("validation and ruleset passes, returns successful", async () => {
    // Arrange
    const epochTime = 2293848;
    const roomCode = "ABCD";
    const username = "daryl_duck";
