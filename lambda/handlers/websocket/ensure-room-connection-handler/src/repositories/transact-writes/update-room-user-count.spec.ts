...
describe("updateRoomUserCount tests", () => {
  it("Creates the correct TransactWriteItem when room is public and current number of users will still be below max users", () => {
    // Arrange
    const roomCode = "ABCD";
    const isPublic = true;
  ...
  it("Creates the correct TransactWriteItem when room is public and current number will equal max users", () => {
    // Arrange
    const roomCode = "ABCD";
    const isPublic = true;
  ...
  it("Creates the correct TransactWriteItem when room is private", () => {
    // Arrange
    const roomCode = "ABCD";
