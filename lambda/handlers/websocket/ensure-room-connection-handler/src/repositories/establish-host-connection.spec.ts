...
describe("establishHostConnection tests", () => {
  ...
  it("correct command is sent and the correct mock methods are called when this is the first connection", async () => {
    // Arrange
  ...
  it("correct command is sent and the correct mock methods are called when this is not the first connection", async () => {
    // Arrange
    const createOrUpdateHostItem = {} as TransactWriteItem;
    (
      createOrUpdateRoomConnection as jest.MockedFunction<
