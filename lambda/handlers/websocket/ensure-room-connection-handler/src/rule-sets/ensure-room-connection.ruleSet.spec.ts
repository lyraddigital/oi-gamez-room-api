...
describe("runEnsureRoomConnectionRuleSet tests", () => {
  it("room not set, returns unsuccessful", () => {
    // Arrange
  ...
  it("room is set and user is host, returns successful", () => {
    // Arrange
    const isUserHost = true;
    const username = "daryl_duck";
    const room = {} as Room;
  ...
  it("room is set, but not available and user is not host, returns unsuccessful", () => {
    // Arrange
  ...
  it("room is set and available and user is not host but room is full, returns unsuccessful", () => {
    // Arrange
    const isUserHost = false;
    const username = "daryl_duck";
    const room = {
  ...
  it("room is set and available and user is not host but already connected to the room, returns unsuccessful", () => {
    // Arrange
    const isUserHost = false;
    const username = "daryl_duck";
    const room = {
  ...
  it("user cannot connect to a room they are not in if the room is no longer available", () => {
    // Arrange
    const isUserHost = false;
    const username = "daryl_duck";
    const room = {
  ...
  it("user can connect to a room they are in when the room is in an in progress status", () => {
    // Arrange
    const isUserHost = false;
    const username = "daryl_duck";
    const room = {
  ...
  it("user can connect to a room they are in when the room is in a completed status", () => {
    // Arrange
    const isUserHost = false;
    const username = "daryl_duck";
    const room = {
