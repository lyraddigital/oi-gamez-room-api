...
import { publishAllHostExpirations } from "./publish-all-host-expirations.service.js";
...
describe("publishAllHostExpirations tests", () => {
  test("raises a set of host connection expired events with different shouldRemoveRoom values given the status of the room", async () => {
    // Arrange
    const roomOne = {
      code: "ABCD",
