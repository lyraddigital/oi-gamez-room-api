...
describe("getAvailableRoomsByCodes tests", () => {
  ...
  describe("normal use cases", () => {
    test("batch get item command returns undefined, returns an empty array", async () => {
      // Arrange
    ...
    test("batch get item command returns a response with no responses set, returns an empty array", async () => {
      // Arrange
      const roomCodes = ["ABCD", "EFGH"];
    ...
    test("batch get item command returns a response with a responses object but not for the right table, returns an empty array", async () => {
      // Arrange
      const roomCodes = ["ABCD", "EFGH"];
      const response = {
        Responses: {},
    ...
    test("batch get item command returns a response with a responses object with result for the correct table, returns an array of mapped responses", async () => {
      // Arrange
      const roomCodes = ["ABCD", "EFGH"];
      const itemOne = {};
      const itemTwo = {};
  ...
  describe("paging use cases", () => {
    test("4 room codes with paging set at 2 rooms per page, makes 2 batch gets", async () => {
      // Arrange
