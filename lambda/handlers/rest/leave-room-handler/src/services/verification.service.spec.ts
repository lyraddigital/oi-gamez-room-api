...
describe("verifyRequest data for leave room tests", () => {
  it("validation does not pass, returns unsuccessful", async () => {
    // Arrange
  ...
  it("rules does not pass, returns unsuccessful", async () => {
    // Arrange
    const origin = "http://localhost:8000";
    const roomCode = "ABCD";
    const payload = {
  ...
  it("all verifications pass, returns successful", async () => {
    // Arrange
    const origin = "http://localhost:8000";
    const roomCode = "ABCD";
    const payload = {
