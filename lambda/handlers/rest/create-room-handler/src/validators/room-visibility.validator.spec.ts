...
describe("validateRoomTitle tests", () => {
  it("room title is not set, returns correct validation result data", () => {
    // Arrange / Action
  ...
  it("room title is less than 5 characters, returns correct validation result data", () => {
    // Arrange
  ...
  it("room title is more than 50 characters, returns correct validation result data", () => {
    // Arrange
  ...
  it("room title is 5 characters, returns correct validation result data", () => {
    // Arrange
  ...
  it("room title is 25 characters, returns correct validation result data", () => {
    // Arrange
  ...
  it("room title is 50 characters, returns correct validation result data", () => {
    // Arrange
