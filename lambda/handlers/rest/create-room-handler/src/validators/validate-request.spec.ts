...
describe("validateRequest tests", () => {
  ...
  it("payload is set, but all data is invalid, returns correct validation result", () => {
    // Arrange
    const origin = "someOrigin";
  ...
  it("payload is set, but game type id is invalid, returns correct validation result", () => {
    // Arrange
    const origin = "someOrigin";
    const payload = {} as CreateRoomPayload;
    const isGameTypeIdErrorMessage = "Invalid game type id";
  ...
  it("payload is set, but room title is invalid, returns correct validation result", () => {
    // Arrange
    const origin = "someOrigin";
    const payload = {} as CreateRoomPayload;
    const roomTitleErrorMessage = "Invalid room title";
  ...
  it("payload is set, but room visibility is invalid, returns correct validation result", () => {
    // Arrange
    const origin = "someOrigin";
    const payload = {} as CreateRoomPayload;
    const roomVisibilityErrorMessage = "Invalid room visibility";
