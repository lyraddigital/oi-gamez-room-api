...
describe("runCreateRoomRuleSet tests", () => {
  it("game type not set and is already hosting, returns correct validation result data", () => {
    // Arrange
  ...
  it("game type not set and is not already hosting, returns correct validation result data", () => {
    // Arrange
  ...
  it("game type is set is already hosting, returns correct validation result data", () => {
    // Arrange
  ...
  it("game type is set is not already hosting, returns correct validation result data", () => {
    // Arrange
    const gameType = {} as GameType;
    const isAlreadyHosting = false;
