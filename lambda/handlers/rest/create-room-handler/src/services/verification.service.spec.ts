...
describe("create room verification tests", () => {
  ...
  it("validation of the data fails, returns an unsuccessful verification result", async () => {
    // Arrange
  ...
  it("validation of the data passes, but ruleset fails, returns an unsuccessful verification result", async () => {
    // Arrange
  ...
  it("validation and ruleset passes, returns a successful verification result", async () => {
    // Arrange
    const origin: string = "http://localhost:8000";
    const gameType: GameType | undefined = {} as GameType;
    const isAlreadyHosting = true;
