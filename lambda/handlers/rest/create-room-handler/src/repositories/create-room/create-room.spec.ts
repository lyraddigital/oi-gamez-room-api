...
describe("createRoom tests", () => {
  ...
  it("makes the correct dynamo db transaction writes when we can not set the division and group code as unavailable", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("makes the correct dynamo db transaction writes when we can set the division and group code as unavailable", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const roomToCreate: RoomToCreate = {
