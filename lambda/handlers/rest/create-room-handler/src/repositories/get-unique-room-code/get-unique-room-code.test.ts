...
describe("getUniqueRoomCode tests", () => {
  ...
  test("makes the correct get command to dynamo db and returns mapped response", async () => {
    // Arrange
  ...
  test("only one code left for division and group code, isRoomCodeExhaused is true", async () => {
    // Arrange
    const divisionCode = "A";
    const groupCode = "A";
  ...
  test("no codes left for division and group code, throws an error", async () => {
    // Arrange
    const divisionCode = "A";
    const groupCode = "A";
  ...
  test("subcodes is not set, throws an error", async () => {
    // Arrange
    const divisionCode = "A";
    const groupCode = "A";
    const getItemResponse: GetItemCommandOutput = {
  ...
  test("Get item command returns no item, throws an error", async () => {
    // Arrange
    const divisionCode = "A";
    const groupCode = "A";
    const getItemResponse: GetItemCommandOutput = {
