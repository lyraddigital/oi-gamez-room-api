...
describe("handleHostDisconnection tests", () => {
  ...
  it("shouldRemoveRoom is true, calls the correct mocks", async () => {
    // Arrange
    const roomCode = "ABCD";
  ...
  it("shouldRemoveRoom is false, and no other connection exists, calls the correct mocks", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
    const hostConnectionId = "conn123";
  ...
  it("shouldRemoveRoom is false, and another connection exists, calls the correct mocks", async () => {
    // Arrange
    const roomCode = "ABCD";
    const username = "daryl_duck";
