...
describe("incrementAndReturnInSeconds tests", () => {
  it("Milliseconds fit perfectly into seconds, returns correct seconds after addition", () => {
    // Arrange
  ...
  it("Milliseconds does not fit perfectly into seconds, returns correct seconds after addition", () => {
    // Arrange
