...
describe("getRoomByCode tests", () => {
  ...
  it("makes the correct query to dynamo db and returns mapped response when no ttl passed", async () => {
    // Arrange
    const roomCode = "ABCD";
    const room: Room = {
      code: roomCode,
  ...
  it("makes the correct query to dynamo db and returns mapped response when a ttl is passed", async () => {
    // Arrange
    const roomCode = "ABCD";
    const ttl = 92929283;
    const room: Room = {
  ...
  it("returns undefined if the query returns an empty array", async () => {
    // Arrange
    const roomCode = "ABCD";
    const queryResponse: QueryCommandOutput = {
      Items: [],
