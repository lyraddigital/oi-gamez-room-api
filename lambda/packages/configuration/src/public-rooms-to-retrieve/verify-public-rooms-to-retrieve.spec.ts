describe("verifyPublicRoomsToRetrieve tests", () => {
  ...
  it("PUBLIC_ROOMS_TO_RETRIEVE variable not set, throws an error", async () => {
    // Arrange
  ...
  it("PUBLIC_ROOMS_TO_RETRIEVE variable is set as a non number, throws an error", async () => {
    // Arrange
  ...
  it("PUBLIC_ROOMS_TO_RETRIEVE variable is set as a number, does not throw an error", async () => {
    // Arrange
    jest.doMock("./public-rooms-to-retrieve", () => {
