describe("verifyExpiredDisconnectionWindowInSeconds tests", () => {
  ...
  it("EXPIRED_DISCONNECTION_WINDOW_IN_SECONDS variable not set, throws an error", async () => {
    // Arrange
  ...
  it("EXPIRED_DISCONNECTION_WINDOW_IN_SECONDS variable is set as a non number, throws an error", async () => {
    // Arrange
  ...
  it("EXPIRED_DISCONNECTION_WINDOW_IN_SECONDS variable is set as a number, does not throw an error", async () => {
    // Arrange
    jest.doMock("./expired-disconnection-window-in-seconds", () => {
