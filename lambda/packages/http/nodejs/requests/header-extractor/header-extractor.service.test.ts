...
describe("extractHeader tests", () => {
  ...
  test("event headers is undefined, returns undefined", () => {
    // Arrange
    const headerKey = "Origin";
  ...
  test("event header is set but key does not exist, returns undefined", () => {
    // Arrange
    const headerKey = "Origin";
    const event = {
  ...
  test("event header key is set, returns header's value", () => {
    // Arrange
    const headerKey = "Origin";
