...
describe("field helper tests", () => {
  describe("dynamo field function tests", () => {
    it("String attribute passed to getDynamoString function with no default value, maps to a correct string", () => {
      // Arrange
    ...
    it("undefined passed to getDynamoString function with no default value, maps to an empty string", () => {
      // Arrange / Action
    ...
    it("undefined passed to getDynamoString function with a default value, maps to the default value", () => {
      // Arrange
    ...
    it("Number attribute passed to getDynamoInt function with no default value, maps to a correct number", () => {
      // Arrange
      const someNumber = 15;
    ...
    it("undefined passed to getDynamoInt function with no default value, maps to a 0", () => {
      // Arrange / Action
    ...
    it("undefined passed to getDynamoInt function with a default value, maps to the default value", () => {
      // Arrange
    ...
    it("Number attribute passed to getOptionalDynamoInt function, maps to a correct number", () => {
      // Arrange
      const someNumber = 15;
      const aNumberAttribute = {
        N: someNumber.toString(),
    ...
    it("undefined passed to getOptionalDynamoInt function, maps to undefined", () => {
      // Arrange / Action
    ...
    it("Bool attribute passed to getDynamoBoolean function with no default value, maps to a correct boolean", () => {
      // Arrange
      const someBool = true;
    ...
    it("undefined passed to getDynamoBoolean function with no default value, maps to false", () => {
      // Arrange / Action
    ...
    it("undefined passed to getDynamoBoolean function with a default value, maps to the default value", () => {
      // Arrange
  ...
  describe("dynamo field name tests", () => {
    it("checks common field names are correct", () => {
    ...
    it("checks connection field names are correct", () => {
      // Arrange / Action / Assert
    ...
    it("checks gameType field names are correct", () => {
      // Arrange / Action / Assert
    ...
    it("checks availableDivisionCodes field names are correct", () => {
      // Arrange / Action / Assert
      expect(dynamoFieldNames.availableDivisionCodes.subCodes).toBe("Subcodes");
    });

    it("checks room field names are correct", () => {
      // Arrange / Action / Assert
  ...
  describe("dynamo field value tests", () => {
    it("checks common field values are correct", () => {
      // Arrange
      const ttl = 100;
    ...
    it("checks connection field values are correct", () => {
      // Arrange
      const roomCode = "ABCD";
    ...
    it("checks game type field values are correct", () => {
      // Arrange
      const gameTypeId = 1;
      const expectedPkAttribute = {
        S: "GameTypes",
    ...
    it("checks unavailable room code field values are correct", () => {
      // Arrange
    ...
    it("checks available division code field values are correct", () => {
      // Arrange
    ...
    it("checks room field values are correct", () => {
      // Arrange
      const roomCode = "ABCD";
  ...
  describe("expression tests", () => {
    it("all common expressions are set correctly", () => {
      // Arrange / Action / Assert
  ...
  describe("key tests", () => {
    it("Correct key values are set for a connection", () => {
      // Arrange
      const roomCode = "ABCD";
      const username = "daryl_duck";
      const expectedKey = {
    ...
    it("Correct key values are set for a game type", () => {
      // Arrange
      const gameTypeId = 1;
      const expectedKey = {
        PK: { S: `GameTypes` },
    ...
    it("Correct key values are set for a room", () => {
      // Arrange
      const roomCode = "ABCD";
      const expectedKey = {
        PK: { S: `Room#${roomCode}` },
    ...
    it("Correct key values are set for an available division code", () => {
      // Arrange
    ...
    it("Correct key values are set for an unavailable division code", () => {
      // Arrange
