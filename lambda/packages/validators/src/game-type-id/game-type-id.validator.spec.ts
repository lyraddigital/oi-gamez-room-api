...
describe("validateGameTypeId tests", () => {
  it("game type id not set, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("game type id is not a number, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("game type id is a negative number, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("game type id is valid number, returns success", () => {
    // Arrange / Action
    const result = validateGameTypeId(1);
