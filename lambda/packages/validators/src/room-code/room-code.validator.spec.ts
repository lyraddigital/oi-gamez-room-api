...
describe("validateRoomCode tests", () => {
  it("room code not set, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("room code is set, but too many letters, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("room code is set, but is not just letters, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("room code is set, but is lowercase letters, returns unsuccessful", () => {
    // Arrange / Action
  ...
  it("room code is set and valid, returns success", () => {
    // Arrange / Action
    const result = validateRoomCode("ABCD");
