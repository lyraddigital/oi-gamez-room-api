...
describe("mapFromDynamoToRoom tests", () => {
  it("maps a DynamoDb record to Room correctly", () => {
    // Arrange
    const roomCode = "ABC1";
  ...
  it("maps room hidden visibility correctly", () => {
    // Arrange
    const visibilityType = "hidden";
    const dbRecord: Record<string, AttributeValue> = {
      VisibilityType: { S: visibilityType },
  ...
  it("maps room visible visibility correctly", () => {
    // Arrange
  ...
  it("maps room not available status correctly", () => {
    // Arrange
    const status = "not available";
    const dbRecord: Record<string, AttributeValue> = {
      Status: { S: status },
  ...
  it("maps room available status correctly", () => {
    // Arrange
  ...
  it("maps room completed status correctly", () => {
    // Arrange
