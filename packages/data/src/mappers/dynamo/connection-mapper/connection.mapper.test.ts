...
import { mapFromDynamoToConnection } from "./connection.mapper.js";

describe("mapFromDynamoToConnection tests", () => {
  test("maps a DynamoDb record to RoomConnection correctly", () => {
    // Arrange
  ...
  test("no last disconnected value in record, returns undefined for LastDisconnected", () => {
    // Arrange
    const dbRecord: Record<string, AttributeValue> = {};
